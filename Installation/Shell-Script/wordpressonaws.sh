...
aws ec2 run-instances --image-id ami-08c40ec9ead489470 --count 1 --instance-type t2.micro --key-name autowordpress --security-groups wp-sec-group --iam-instance-profil Name=LabInstanceProfile --user-data file://~/M346-CMS-WORDPRESS/Installation/Cloud-Init/cloud-config.yaml --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=Wordpress}]'